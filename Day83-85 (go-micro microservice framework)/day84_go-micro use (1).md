...
To install and start mqtt on the windows system, you can download the latest installation file from [https://activemq.apache.org/](https://activemq.apache.org/), and then install and run it.
