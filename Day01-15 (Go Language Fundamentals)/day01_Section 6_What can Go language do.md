...
-Application scope: Restful API (using Beego), statistical analysis platform, common services such as sending mail, asynchronous queue processing, statistical user space and interface requests
### Group Strategy
...
Barrage
### Giant Network
The server side of some mobile games.
### Today's headlines
