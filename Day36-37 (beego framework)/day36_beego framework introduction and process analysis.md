...
You can see the output log saying that the http service has been running on the port [http://localhost:8080](http://localhost:8080). Now let’s go to the browser to verify it, and the effect is as follows:
