...
​ Reflection is a mechanism for detecting the type and value stored in the interface. This can be obtained through the TypeOf function and the ValueOf function.
